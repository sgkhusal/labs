...
1. [Encoding and decoding](#Encoding_and_decoding)
2. [Data Compression](#Data_compression)
3. [Huffman Coding](#Huffman_Coding)
4. [Use of shared memory between programs](#Use_of_shared_memory_between_programs)
